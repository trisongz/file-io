...
if TYPE_CHECKING:
    from .filesys import S3FileSystem
...
class R2AsyncStreamedFile(S3File, AbstractAsyncStreamedFile):
    fs: 'S3FileSystem' = None
    ...
    def __init__(self, fs: 'S3FileSystem', path, mode, encoding: Optional[str], errors: Optional[str], newline: Optional[str], buffering: Optional[int], **kwargs):
