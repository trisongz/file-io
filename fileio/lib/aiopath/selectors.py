...
from fileio.lib.pathz import _is_wildcard_pattern, _ignore_error, _Flavour
from fileio.lib.aiopath.wrap import CoroutineMethod
...
class _RecursiveWildcardSelector(_AsyncSelector):
    ...
    async def _select_from(self, parent_path, is_dir, exists, scandir) -> AsyncIterable['FilePath']:
        try:
            yielded = set()
